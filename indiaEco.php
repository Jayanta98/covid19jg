...
<body style="background-color:rgb(161, 240, 14)">
    ...
    <mARquee class="text-danger"> <b>Indian Economy in Crisis !!!</b> </mARquee>


    <div class="container-fluid">

        <h1 class="container text-center text-white p-3">Corona : Economic Impact in India</h1>
    </div>


    <div class=" container justify-content-center align-content-center  p-3">

        <div class="row">
            <div class="col-12 col-lg-6 col-md-6">
                <img class="img-fluid rounded-border animated bounceIn" src="inter.jpg" alt="">
            </div>
            <div class="col-12 col-lg-6 col-md-6">
                <div class="container-fluid justify-content-center align-content-center p-3">
                    <p class="card-text text-dark font-weight-bolder text-left p-3 animated bounceIn">
                        According to the survey, COVID-19 is having a 'deep impact' on Indian businesses,
                        over the coming month's jobs are at high risk because firms are looking for some reduction
                        in manpower. Further, it is added that already COVID-19 crisis has caused an unprecedented
                        collapse in economic activities over the last few weeks. The present situation is having a "high to very high"
                        level impact on their business according to almost 72 per cent
                        respondents. Further, 70 per cent of the surveyed firms are expecting a degrowth sales in the fiscal year 2020-21.
        ...
        <div class="container-fluid">
            ...
            <h1 class="container text-center text-white p-3"> Corona : Financial Crisis</h1>
        </div>
        ...
        <div class="container justify-content-center align-content-center d-flex">
            <img class="img-fluid rounded-pill " src="finance.jpg" alt="">


        </div>
        <div class="container justify-content-center align-content-center d-flex p-3">
            <a class=" my-2 my-sm-0 btn btn-outline-primary btn-lm" href="https://www.finmin.nic.in/"><b>Click-Me</b></a>
